...
```
GlobalSolution/
├── 1_AICSS/                   # Scripts de análise
│   ├── src/                   # Código fonte do Wokwi
│   └── README.md              # Documentação da solução
├── 2_SCR/                     # Scripts de análise
│   └── src/                   # Configurações e funções auxiliares
...
│   └── README.md   # Documentação da solução
├── 3_CDS/          # Scripts de análise
│   ├── src/        # Configurações e funções auxiliares
│   └── part3.R     # Visualizações e insights
│   └── README.md   # Documentação da solução
├── 4_CTWP/         # Scripts de análise
│   ├── src/        # Configurações e funções auxiliares
│   ├── part1.R     # Configurações e funções auxiliares
│   ├── part2.R     # Análises estatísticas
│   └── part3.R     # Visualizações e insights
